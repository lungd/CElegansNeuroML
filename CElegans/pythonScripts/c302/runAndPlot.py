...
if __name__ == '__main__':
    ...
    if '-full' in sys.argv:
        ...
        main('TapWithdrawal','A','',2000,0.05,'jNeuroML_NEURON')
    elif '-twcB' in sys.argv:
        main('TapWithdrawal','B','',2000,0.05,'jNeuroML_NEURON')
    elif '-twcC' in sys.argv:
        main('TapWithdrawal','C','',2000,0.05,'jNeuroML_NEURON')
    elif '-twcC1' in sys.argv:
        main('TapWithdrawal','C1','',2000,0.05,'jNeuroML_NEURON')
    elif '-twcC2' in sys.argv:
        main('TapWithdrawal','C2','',2000,0.05,'jNeuroML_NEURON', data_reader='UpdatedSpreadsheetDataReader')
    elif '-twcD' in sys.argv:
        main('TapWithdrawal','D','',2000,0.05,'jNeuroML_NEURON')
    elif '-twcD1' in sys.argv:
        main('TapWithdrawal','D1','',2000,0.05,'jNeuroML_NEURON')
